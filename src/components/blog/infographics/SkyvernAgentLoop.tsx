...
export function SkyvernAgentLoop() {
  return (
    <div className="my-10 rounded-2xl border border-white/10 bg-neutral-950 p-6 sm:p-8">
      ...
      >
        <IconRefresh size={14} className="text-pink-400/70" />
        <span>repeat until the goal is met</span>
        <span className="text-neutral-600">·</span>
        <span>no selectors anywhere in the loop</span>
      </motion.div>
    </div>
  );
}

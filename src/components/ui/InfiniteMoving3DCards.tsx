...
// ============ 3D Card Components (Your Original) ============
...
// ============ Infinite Moving 3D Cards Component ============
  ...
  return (
    ...
    >
      <ul
        ref={scrollerRef}
        className={cn(
          "flex w-max min-w-full shrink-0 flex-nowrap gap-20 py-16",
...
export default function Demo() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-zinc-950 flex items-center justify-center py-20">

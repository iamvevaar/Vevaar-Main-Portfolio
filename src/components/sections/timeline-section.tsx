          ...
          <CollapsibleReveal>
            ...
            <div className="flex items-start gap-2 text-xs text-neutral-700 md:text-sm dark:text-neutral-300">
              ...
              <p>
                ...
                Built the Microsites feature end-to-end (frontend + horoscope microservice backend),
                enabling public landing pages for direct report purchases — scaling platform revenue
                from ₹4–5K to ₹2–2.5L/month.
              </p>
            </div>
            <div className="flex items-start gap-2 text-xs text-neutral-700 md:text-sm dark:text-neutral-300">
              <div>
              ...
              <p>
                <span className="font-extrabold underline underline-offset-4">
                  Astrosure Platform Architecture :{" "}
                </span>
                Architected and built the Astrosure web platform from scratch in Next.js, owning
                frontend architecture, project structure, and core development standards adopted
                across the team.
              </p>
            </div>
            <div className="flex items-start gap-2 text-xs text-neutral-700 md:text-sm dark:text-neutral-300">
              ...
              <p>
                ...
                Developed an AI-powered astrology chatbot delivering personalized insights to
            ...
            <div className="flex items-start gap-2 text-xs text-neutral-700 md:text-sm dark:text-neutral-300">
              ...
              <p>
                ...
                Integrated Razorpay SDK for end-to-end payment flows across subscription tiers,
                handling webhooks, order lifecycle, and cross-platform purchase reconciliation.
              </p>
            </div>
            <div className="flex items-start gap-2 text-xs text-neutral-700 md:text-sm dark:text-neutral-300">
              <div>
              ...
              <p>
                ...
                Implemented rate limiting across multiple subscription plans, enforcing usage
                boundaries and protecting service reliability at scale.
              </p>
            </div>
            <div className="flex items-start gap-2 text-xs text-neutral-700 md:text-sm dark:text-neutral-300">
              <div>
              ...
              <p>
                ...
                Engineered an influencer onboarding flow with QR-based activation granting free
                trial subscriptions, supporting partnership and user acquisition campaigns.
              </p>
            </div>
            <div className="flex items-start gap-2 text-xs text-neutral-700 md:text-sm dark:text-neutral-300">
              <div>
              ...
              <p>
                <span className="font-extrabold underline underline-offset-4">
                  Microservice Backend Contributions :{" "}
                </span>
                Contributed to backend services within a 9-service FastAPI microservice
                architecture, primarily in the users, subscriptions, and horoscope domains.
              </p>
            </div>
            <div className="flex items-start gap-2 text-xs text-neutral-700 md:text-sm dark:text-neutral-300">
              <div>
              ...
              <p>
                ...
                Established CI/CD pipelines, testing standards, and quality gates, improving
          ...
          <div className="hidden md:grid grid-cols-2 gap-4">
            {item.images.map((image: any, idx: number) => (
              <Link
                ...
                key={`image-${idx}`}
                target="_blank"
                className={`relative group overflow-hidden rounded-lg ${idx === 0 ? "" : "bg-white/[0.03] ring-1 ring-inset ring-white/[0.06]"}`}
              >
                <img
                  src={image.src}
                  alt={image.alt}
                  width={500}
                  height={500}
                  className={`h-20 w-full rounded-lg ${idx === 0 ? "object-cover" : "object-contain"} shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset] md:h-44 lg:h-60 transition-all duration-300 group-hover:scale-105 group-hover:blur-sm`}
                />
                <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <div className="relative bg-clip-text text-transparent bg-no-repeat bg-gradient-to-r from-purple-500 via-violet-500 to-pink-500 py-4 text-lg font-bold transform -translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                    <span className="flex items-center gap-2">

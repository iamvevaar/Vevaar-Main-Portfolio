  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-xl mx-auto space-y-6 mb-8">
        ...
        <div className="mb-6">
          <label
            className={`block text-base font-medium text-gray-700 dark:text-gray-300 mb-1 pl-4`}
          >
            Name
          </label>
      ...
      {message.text && (
        <div
          className={`mt-4 px-4 py-2 rounded-md text-sm transition-opacity duration-300
